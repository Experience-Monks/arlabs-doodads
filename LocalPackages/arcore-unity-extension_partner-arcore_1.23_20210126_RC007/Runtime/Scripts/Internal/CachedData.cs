...
namespace Google.XR.ARCoreExtensions.Internal
{
    ...
    {
        public const string RawDepthTimestamp = "rawDepthTimestamp";
        public const string RawDepthTexture = "rawDepthTexture";
        public const string RawDepthConfidenceTimestamp = "rawDepthConfidenceTimestamp";
        public const string RawDepthConfidenceTexture = "rawDepthConfidenceTexture";

        public const string PersonMaskTextureTimestamp = "personMaskTextureTimestamp";
        public const string PersonMaskTexture = "personMaskTexture";
