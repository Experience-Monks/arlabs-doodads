...
namespace Google.XR.ARCoreExtensions.Internal
{
    ...
    internal class AnchorApi
    {
        ...
        public static CloudLocalizationState GetCloudLocalizationState(
            IntPtr sessionHandle,
            IntPtr anchorHandle)
        {
            int state = (int)CloudLocalizationState.None;
            ExternApi.ArAnchor_getCloudLocalizationState_private(
                sessionHandle, anchorHandle, ref state);
            return (CloudLocalizationState)state;
        }
        ...
        private struct ExternApi
        {
            ...
            [DllImport(ApiConstants.ARCoreNativeApi)]
            public static extern void ArAnchor_getCloudLocalizationState_private(
                IntPtr sessionHandle, IntPtr anchorHandle, ref int state);
