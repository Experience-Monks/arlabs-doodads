...
namespace Google.XR.ARCoreExtensions
{
    ...
    public class ARCloudAnchor : MonoBehaviour, ITrackable
    {
        ...
        /// <summary>
        /// Gets the current CloudLocalizationState of the anchor. Can be used to
        /// determine if the anchor has been successfully localized against the
        /// global Earth map, or its local map, or both.
        /// </summary>
        public CloudLocalizationState cloudLocalizationState
        {
            get
            {
                return AnchorApi.GetCloudLocalizationState(
                    ARCoreExtensions._instance.currentARCoreSessionHandle,
                    _anchorHandle);
            }
        }
