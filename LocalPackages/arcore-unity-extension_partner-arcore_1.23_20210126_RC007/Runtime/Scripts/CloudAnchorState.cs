...
namespace Google.XR.ARCoreExtensions
{
    ...
    public enum CloudAnchorState
    {
        ...
        /// <summary>
        /// The Earth-localized Cloud Anchor could not be resolved because the
        /// device's localized position is too far away from the anchor's position.
        /// Cloud Anchors that were hosted with Earth localization can only be
        /// resolved up to 50m away from the Cloud Anchor's position.
        /// </summary>
        ErrorResolvingLocalizedTooFarAway,
    }
}
